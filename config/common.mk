...
ifeq ($(OWNROM_RELEASE),true)
    OWNROM_VERSION := OwnROM-$(OWNROM_VERSION_MAIN)-$(OWNROM_VERSION_MAJOR).$(OWNROM_VERSION_MINOR)-OFFICIAL-$(shell date +%Y.%m.%d)-$(OWNROM_BUILD)
else
    OWNROM_VERSION_STATE := UNOFFICIAL
    OWNROM_VERSION := OwnROM-$(OWNROM_VERSION_MAIN)-$(OWNROM_VERSION_MAJOR).$(OWNROM_VERSION_MINOR)-$(OWNROM_VERSION_STATE)-$(shell date +%Y.%m.%d)-$(OWNROM_BUILD)
endif
