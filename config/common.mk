...
OWNROM_VERSION_MINOR = 2

# release
ifeq ($(OWNROM_RELEASE),true)
    OWNROM_VERSION := OwnROM-$(OWNROM_BUILD)-$(OWNROM_VERSION_MAIN)-$(OWNROM_VERSION_MAJOR).$(OWNROM_VERSION_MINOR)-OFFICIAL-$(shell date -u +%Y.%m.%d)
else
    OWNROM_VERSION_STATE := UNOFFICIAL
    OWNROM_VERSION := OwnROM-$(OWNROM_BUILD)-$(OWNROM_VERSION_MAIN)-$(OWNROM_VERSION_MAJOR).$(OWNROM_VERSION_MINOR)-$(OWNROM_VERSION_STATE)-$(shell date -u +%Y.%m.%d)
endif
